...
public class PylosGrid {
	...
	//public PylosPartie partie; // Partie actuelle, avec toutes les variables utiles et l'�tat du jeu
	...
	// Equipe qui occupe cette cellule : sans v�rification de la validit� de la position
