...
public class PylosPartie {
	...
	public boolean tourSuivant() {
		...
		if (nbJetonsBlanc <= 0) { 
			...
			JOptionPane.showMessageDialog(null, "Victoire de blanc!", "Information", JOptionPane.INFORMATION_MESSAGE);
		...
		if (nbJetonsNoir <= 0) { 
			JOptionPane jop1;
			jop1 = new JOptionPane();
			JOptionPane.showMessageDialog(null, "Victoire de noir!", "Information", JOptionPane.INFORMATION_MESSAGE);
			return false; // fin de la partie !
		}
